...
class LatestSpacePayments extends TableWidget
{
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('user.name')
                    ->label('کاربر')
                    ->formatStateUsing(fn (?string $state, Payment $record): string => $state ?: ($record->user?->mobile ?? '-'))
                    ->searchable()
                    ->toggleable(),
